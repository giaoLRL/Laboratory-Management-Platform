...
ENABLE_DEBUG_TOOLBAR = getattr(configuration, 'ENABLE_DEBUG_TOOLBAR', True)
...
EMAIL_SUBJECT_PREFIX = '[LabManager] '
...
if (not DEBUG or not ENABLE_DEBUG_TOOLBAR) and 'collectstatic' not in sys.argv:
