...
# CableLengthUnitChoices stub (dcim module removed)
class CableLengthUnitChoices:
    UNIT_KILOMETER = 'km'
    UNIT_METER = 'm'
    UNIT_CENTIMETER = 'cm'
    UNIT_MILE = 'mi'
    ...
    @classmethod
    def values(cls):
        return [cls.UNIT_KILOMETER, cls.UNIT_METER, cls.UNIT_CENTIMETER,
                cls.UNIT_MILE, cls.UNIT_FOOT, cls.UNIT_INCH]
