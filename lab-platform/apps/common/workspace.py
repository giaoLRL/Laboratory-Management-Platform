def build_workspace(profile, staff):
    ...
    members_profiles = list(MemberProfile.objects.select_related('user'))
    ...
    for fn in (inventory_slice, leaves_slice, competitions_slice, tasks_slice, checkins_slice, notify_slice, points_slice):
